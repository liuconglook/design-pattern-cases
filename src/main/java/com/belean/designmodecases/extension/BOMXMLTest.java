 ...
 * @date 2021/10/19
 */
public class BOMXMLTest extends TestCase {

    private PiecePart p1;
    private PiecePart p2;
    private Assembly a;

    public BOMXMLTest(String name) {
        super(name);
    }
    ...
    public void testPiecePart1XML() {
        ...
        assertEquals(3.2, Double.parseDouble(xml.getChild("Cost").getTextTrim()), 0.01);
    }
    ...
    public void testPiecePart2XML() {
        ...
        assertEquals(666, Double.parseDouble(xml.getChild("Cost").getTextTrim()), 0.01);
    }
    ...
    public void testAssemblyWithCSV() {
        a.add(p1);
        a.add(p2);
        PartExtension e = a.getExtension("CSV");
        CSVPartExtension ce = (CSVPartExtension) e;
